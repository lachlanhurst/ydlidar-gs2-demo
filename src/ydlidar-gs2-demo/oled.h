...
public:
    ...
    OLED(uint8_t i2c_address, uint_fast8_t width, uint_fast8_t height, bool isSH1106=false);
     ...
     * @param i2c_address The I²C address is usually 0x3c or 0x3D.
     */
    OLED(tWidth width=W_128, tHeight height=H_32, tDisplayCtrl displayCtrl=CTRL_SSD1306, uint8_t i2c_address=0x3C);
